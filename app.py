...
def extraer_datos(texto):
    ...
    - id_pac, edad, sexo, peso, talla, eti_erc, eti_ic, dm2, hta, fa, epoc, sd_metab, creat, fge, ast, alt, plaq, nt_probnp, ca125, fevi, tapse, lsm, ieca, bb, sglt2i, diur_tipo, diur_dosis
    ...
    if st.button("💾 Guardar Registro en Excel", use_container_width=True):
        if not st.session_state.id_pac:
            ...
            try:
                ...
                wb.save(EXCEL_FILE)
                st.success(f"✅ Paciente {s.id_pac} guardado correctamente.")
